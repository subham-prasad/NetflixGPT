...
const GptSearchBar = () => {
  ...
  return (
    <div className=" flex justify-center pt-[30%] md:pt-[20%]">
      <form
        className=" w-full md:w-1/2 m-4 bg-black grid grid-cols-12 rounded-xl"
      ...
      >
        ...
        <button
          ...
          className="bg-red-500 text-white rounded-lg col-span-3 p-4 m-4"
        >
          {lang[langKey].search}
        </button>
      </form>
